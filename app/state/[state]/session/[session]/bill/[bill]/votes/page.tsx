            ...
            <li key={vote.roll_call_id} className="w-full my-4">
              <Card className="p-4">
                <CardBody>
                  ...
                  <p className="line-clamp-1">
                    <strong>Description:</strong> {vote.desc}
                  </p>
                  <p className="line-clamp-1">
                    <strong>Yea:</strong> {vote.yea}
                  </p>
                  <p className="line-clamp-1">
                    <strong>Nay:</strong> {vote.nay}
                  </p>
                  <p className="line-clamp-1">
                    <strong>NV:</strong> {vote.nv}
                  </p>
                  <p className="line-clamp-1">
                    <strong>Absent:</strong> {vote.absent}
                  </p>
                  <p className="line-clamp-1">
                    <strong>Total:</strong> {vote.total}
                  </p>
                  <p className="line-clamp-1">
                    <strong>Passed:</strong> {vote.passed}
                  </p>
                </CardBody>
              </Card>
            </li>
